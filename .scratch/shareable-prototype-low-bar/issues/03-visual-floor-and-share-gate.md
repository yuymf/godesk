# 03 — Visual Floor：排版渲染 + 主题 kit + 分享门闩

**What to build:** A Playable Build only becomes shareable after it meets the
Visual Floor. When generative APIs are unavailable, the floor is assembled in
order: extracted rulebook art, then typographic/programmatic card and board
rendering, then a designed theme fallback kit. Pure text or naked placeholders
never pass.
