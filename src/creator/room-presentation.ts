...
export const ROOM_COPY = {
  zh: {
    ...
    experimentTitle: "创作者想请你留意",
    experimentSignal: "特别想听：",
    experimentFeedbackHint: "完成一次行动后，围绕上面那句话留下评分和感受；创作者会在同一项目里看到。",
    experimentFeedbackComment: "你觉得怎么样？",
  },
  en: {
    room: "Shared Session · reconnectable",
    studio: "Back to studio",
    replay: "How this game ended",
    language: "Language",
    ...
    experimentTitle: "The creator wants your take on this",
    experimentSignal: "They especially want to hear: ",
    experimentFeedbackHint: "After one action, leave a rating and a sentence about the note above. It goes back to the same project.",
    experimentFeedbackComment: "What did you think?",
  },
} as const;
