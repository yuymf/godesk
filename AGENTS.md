...
shareable prototype — and, as capability grows, mature playable game content.
Other people join through a URL and play together. They do not install Codex.
...
Read `CONTEXT.md` and `docs/adr/0011-chatcut-playable-output-is-the-product.md`
before exploring or editing. Use glossary terms from `CONTEXT.md`. If work
